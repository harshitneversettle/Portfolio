...
export default function Navbar({ className }: { className?: string }) {
  ...
  return (
    <>
      <div className="h-10 mt-17 ml-5  items-center flex w-full justify-between ">
        <div className="items-center justify-center -mt-15 flex">
          <img src="/sol.png" alt="" className="w-10 h-10" />
        ...
        <div className="">
          <div
            className={cn(
              "absolute ml-310 inset-x-0 max-w-2xl z-50",
              className
            )}
          >
            <div
              className={cn(
                " md:w-[20rem] sm:max-w-2xl relative mt-5  md:mt-[-55px] md:mr-5"
              )}
            >
                ...
                <MenuItem setActive={setActive} active={active} item="Contacts">
                  ...
                  <Link href="https://x.com/Harshit_yad4v" target="_blank">
                    <svg
                      ...
                      height="27"
                      fill="currentColor"
                      className="bi bi-twitter-x mt-5"
                      viewBox="0 0 16 16"
                    >
