      ...
      <div className="flex flex-col lg:flex-row gap-6 w-full ml-20">
        <div className="shadow-input w-full lg:max-w-md rounded-none bg-white mx-auto p-4 md:rounded-2xl md:p-8 dark:bg-black">
          ...
          <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
            Contact me for freelance projects, suggestions , or any questions
            you may have!
          </p>
          ...
          <form className="my-8" onSubmit={handleSubmit}>
            <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
              ...
              <LabelInputContainer>
                ...
                <Input id="lastname" placeholder="Kohli" type="text" />
              </LabelInputContainer>
            </div>
            <LabelInputContainer className="mb-4">
              ...
              <Input
                id="email"
                placeholder="harshityadav.mits@gmail.com"
                type="email"
              />
            </LabelInputContainer>
            ...
            <LabelInputContainer className="mb-8">
              ...
              <textarea
                ...
                className={cn(
                  " flex w-full flex-col space-y-2 shadow-input rounded-md border border-gray-300 p-2 dark:bg-zinc-900 dark:text-neutral-200"
                )}
              ></textarea>
              <BottomGradient />
            </LabelInputContainer>
